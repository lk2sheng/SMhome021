...
function schedule() {
    ...
    if (selectedDays.length > 0 && selectedHour != undefined && selectedMinute != undefined && selectedHour2 != undefined && selectedMinute2 != undefined) {
        ...
        let ScheduleData = new ScheduleAC("AC QUARTO",isACOn,currentTemperature,currentPower,currentMode, selectedDays, selectedHour, selectedMinute, selectedHour2, selectedMinute2);
...
function saveChanges() {
    if (change) {
        ...
        confirmYes.addEventListener('click', function() {
            ...
            ACinfo.push(ACData);
            localStorage.setItem("ACQUARTO",JSON.stringify(ACinfo));
            change = false;
        ...
        confirmNo.addEventListener('click', function() {
            ...
            let storedACInfo = localStorage.getItem("ACQUARTO");
            if (storedACInfo) {
